...
class MPIIDataset(JointsDataset):
    def __init__(self, cfg, root, image_set, is_train, use_SA, transform=None):
        ...
        # self.semantic_augmentation_pool = semantic_augmentation_pool
        # self.aug_idxes = aug_idxes
        if use_SA:
    ...
    def evaluate(self, cfg, preds, output_dir, *args, **kwargs):
        ...
        PCKh.mask[6:8] = True
        #
        PCKh.mask = PCKh.mask | (jnt_count==0)

        jnt_count = np.ma.array(jnt_count, mask=False)
        jnt_count.mask[6:8] = True
        #
        jnt_count.mask = jnt_count.mask | (jnt_count==0)
