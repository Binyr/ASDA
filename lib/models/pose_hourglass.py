...
class PoseResNet(nn.Module):
    ...
    def __init__(self, block, layers, cfg, **kwargs):
        ...
        # )
        net = cfg.MODEL.NET
        self.hourglass = StackedHourGlass(nChannels=net.NCHANNELS, nStack=net.NSTACKS,
                                          nModules=net.NMODULES, numReductions=net.NREDUCTIONS,
                                          nJoints= cfg.MODEL.NUM_JOINTS)
